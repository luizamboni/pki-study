...
# normalize names (to make equal to openssh process)
mv ./certs/exerciciosresolvidos-key.pem ./certs/exerciciosresolvidos.key
mv ./certs/exerciciosresolvidos.pem     ./certs/exerciciosresolvidos.crt
